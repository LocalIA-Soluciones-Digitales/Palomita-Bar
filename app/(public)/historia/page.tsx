...
export default function HistoriaPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-24">
      <p className="text-xs uppercase tracking-widest2 text-brand-pink">Historia</p>
      <h1 className="mt-4 font-display text-5xl">Quiénes somos</h1>
      <p className="mt-8 text-lg leading-relaxed text-brand-ink/70">
